...
export declare const CREDIT_CARD_TARGET = "payments.credit-card.render";
export declare const CreditCardPaymentsAppExtensionSchema: zod.ZodEffects<zod.ZodEffects<zod.ZodObject<{
    name: zod.ZodString;
...
export declare function creditCardPaymentsAppExtensionDeployConfig(config: CreditCardPaymentsAppExtensionConfigType): Promise<{
    [key: string]: unknown;
} | undefined>;
