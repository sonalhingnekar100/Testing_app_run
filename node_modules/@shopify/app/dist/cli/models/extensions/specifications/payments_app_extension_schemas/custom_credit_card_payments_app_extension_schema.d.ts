...
export type CustomCreditCardPaymentsAppExtensionConfigType = zod.infer<typeof CustomCreditCardPaymentsAppExtensionSchema>;
export declare const CUSTOM_CREDIT_CARD_TARGET = "payments.custom-credit-card.render";
export declare const CustomCreditCardPaymentsAppExtensionSchema: zod.ZodObject<{
    name: zod.ZodString;
...
export declare function customCreditCardPaymentsAppExtensionDeployConfig(config: CustomCreditCardPaymentsAppExtensionConfigType): Promise<{
    [key: string]: unknown;
} | undefined>;
