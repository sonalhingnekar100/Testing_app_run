...
export declare const REDEEMABLE_TARGET = "payments.redeemable.render";
export declare const RedeemablePaymentsAppExtensionSchema: zod.ZodObject<{
    name: zod.ZodString;
...
export declare function redeemablePaymentsAppExtensionDeployConfig(config: RedeemablePaymentsAppExtensionConfigType): Promise<{
    [key: string]: unknown;
} | undefined>;
