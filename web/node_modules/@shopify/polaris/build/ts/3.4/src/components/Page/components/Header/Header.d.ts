...
export declare function Header({ title, subtitle, titleMetadata, additionalMetadata, titleHidden, primaryAction, pagination, additionalNavigation, breadcrumbs, backAction, secondaryActions, actionGroups, compactTitle, onActionRollup, }: HeaderProps): JSX.Element;
export {};
