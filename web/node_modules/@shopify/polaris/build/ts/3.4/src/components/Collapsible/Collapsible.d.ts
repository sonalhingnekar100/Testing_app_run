...
export declare function Collapsible({ id, expandOnPrint, open, transition, preventMeasuringOnChildrenUpdate, children, onAnimationEnd, }: CollapsibleProps): JSX.Element;
export {};
